...
//Add User ID
export const addUserId = (gcount, limitCount, tanggal, pushname, sender, _level) => {                                                                                                                      
...
export const getLevelingXp = (sender, _level) => {
	let position = false
...
export const getLevelingLevel = (sender, _level) => {
	let position = false
	Object.keys(_level).forEach((i) => {
		if (_level[i].id === sender) {
			position = i
...
export const getLevelingId = (sender, _level) => {
	let position = false
	Object.keys(_level).forEach((i) => {
		if (_level[i].id === sender) {
			position = i
...
export const getDateId = (sender, _level) => {
	let position = false
	Object.keys(_level).forEach((i) => {
		if (_level[i].id === sender) {
			position = i
...
export const addLevelingXp = (sender, amount, _level ) => {
	let position = false
	Object.keys(_level).forEach((i) => {
		if (_level[i].id === sender) {
			position = i
...
export const resetLevelingXp = (sender, amount, _level ) => {
	let position = false
	Object.keys(_level).forEach((i) => {
		if (_level[i].id === sender) {
			position = i
...
export const addLevelingLevel = (sender, amount, _level) => {
	let position = false
	Object.keys(_level).forEach((i) => {
		if (_level[i].id === sender) {
			position = i
...
export const userLeveling = (levelRole) => {
	var role = `Newbie ㋡`
                   if (levelRole <= 2) {
            return role = `Newbie ㋡`
        } else if (levelRole <= 4) {
